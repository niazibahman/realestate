...
export default function SideMenu({show,closeMenu}){
    ...
    return(
    <div className={`fixed inset-y-0 right-0 overflow-hidden bg-white z-40 lg:hidden w-3/5 transition-all duration-300 ${show === true ? "translate-x-0" : "translate-x-full"}`}>
