    ...
    <section className="w-full h-auto bg-grayBackground">
        <div className="w-full h-auto px-6  sm:px-0 sm:container mx-auto flex flex-col items-center py-16">
            ...
            <div className="w-full h-auto grid grid-cols-1 md:grid-cols-3 gap-10 mt-8">
                <Link href={'/search/املاک/تهران'} className="col-span-1 md:col-span-2 h-96 relative rounded-lg overflow-hidden">
                ...
                <Link href={'/search/املاک/تبریز'} className="col-span-1 h-96 relative rounded-lg overflow-hidden">
                ...
                <Link href={'/search/املاک/اهواز'} className="col-span-1 h-96 relative rounded-lg overflow-hidden">
                ...
                <Link href={'/search/املاک/شیراز'} className="col-span-1 h-96 relative rounded-lg overflow-hidden">
                ...
                <Link href={'/search/املاک/همدان'} className="col-span-1 h-96 relative rounded-lg overflow-hidden">
