...
export default function Footer(){
    return(<footer className="w-screen h-auto text-footerText text-sm">
        ...
        <section className="bg-copyRightFooter w-full">
            <div className="px-4 py-5 lg:container mx-auto grid grid-cols-2 gap-2">
              <p>تمامی حقوق سایت محفوظ است.</p>
              <div className="flex flex-row items-center justify-end">
                <Image src="/svg/instagram.svg" alt="instagram account" width={20} height={20} className="ml-4"/>
                <Image src="/svg/linkedin.svg" alt="linkedin account" width={20} height={20} className="ml-4"/>
                <Image src="/svg/twitter.svg" alt="twitter account" width={20} height={20} className="ml-4"/>
                <Image src="/svg/facebook.svg" alt="facebook account" width={20} height={20}/>
              </div>
            </div>
        </section>
    </footer>);
